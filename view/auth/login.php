...
<html >
  <head>
    <meta charset="UTF-8">
    <title>Farmacia Santa Rosa</title>
    <link rel="icon" href="<?php asset('logo.png'); ?>" type="image/vnd.microsoft.icon">
...
.login input:focus,select {
  outline: none;
  color: #444;
  border-color: #2196F3;
  border-left-width: 35px;
}
.login input:focus + i.fa,select +i.fa{
  opacity: 1;
  left: 30px;
...
footer a, footer a:link {
  ...
  <body>
    ...
    <div class="wrapper" style="padding: 0;">
        <h1 style="color: white; font-size: 70px;">Farmacia Santa Rosa</h1>
          <form class="login" action="<?php url("login/ingresar"); ?>" method="post">
            <p class="title">Login</p>

            <input type="text" placeholder="Usuario" autofocus name="usuario" id="usuario">
            <i class="fa fa-user"></i>

             <input type="password" placeholder="Contraseña" name="clave" id="clave">
              <i class="fa fa-key"></i>

              <select name="caja" id="" class="input">
