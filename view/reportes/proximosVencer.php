...
//Recibir los datos de la empresa
    ...
    $nombre_reporte='Productos proximos a vencer';



//variable que guarda el nombre del archivo PDF
    $archivo="proximos-vencer-".$fecha_reporte.".pdf";
...
//Creaci�n de la tabla de los detalles de los productos productos
    ...
    $pdf->Cell(40, 5, 'Fecha Vencimiento', 0, 1, 'L');
    ...
    foreach ($productos as $producto)
    {
        ...
        $pdf->SetXY(145, $y);
        $pdf->Cell(40, 5, $producto['fecha_vencimiento'], 0, 1, 'L');
