...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"> Productos proxomos a vencer
                </h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form action="<?php url("reportes/proximosVencer"); ?>" method="post" role="form" target="_blank">
                            <legend>Productos proxomos a vencer antes de la fecha:</legend>
